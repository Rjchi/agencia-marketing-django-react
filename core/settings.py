...
# Cuando despleguemos en render esta variable va a estar en false (en este momento esta en True)
...
# La url viene de la base de datos que creamos en render.com
# Una vez configurado esto en la ultima fase debemos migrar la base de datos
DATABASES = {
    # este seria el External Database URL:
